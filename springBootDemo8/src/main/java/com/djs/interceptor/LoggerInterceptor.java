...
import com.djs.jpa.LoggerJPA;
import com.djs.util.LoggerUtils;

public class LoggerInterceptor implements HandlerInterceptor{

	//请求开始时间标识
	private static final String LOGGER_SEND_TTIME = "_send_time";
	//请求日志实体标识
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
		...
		//请求开始时间
		Long time = Long.valueOf(request.getAttribute(LOGGER_SEND_TTIME).toString());
		//获取本次请求日志实体
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		//设置请求开始时间
		request.setAttribute(LOGGER_SEND_TTIME, System.currentTimeMillis());
